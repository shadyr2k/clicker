...
public class Wrinkly_cookies extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Wrinkly_cookies(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Wrinkly_cookies.png"));
