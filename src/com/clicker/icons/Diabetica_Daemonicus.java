...
public class Diabetica_Daemonicus extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Diabetica_Daemonicus(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Diabetica_Daemonicus.png"));
