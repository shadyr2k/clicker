...
public class Golden_switch extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Golden_switch(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Golden_switch.png"));
