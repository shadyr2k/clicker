...
public class Lasting_fortune extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Lasting_fortune(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Lasting_fortune.png"));
