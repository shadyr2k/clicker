...
public class Sugar_aging_process extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Sugar_aging_process(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Sugar_aging_process.png"));
