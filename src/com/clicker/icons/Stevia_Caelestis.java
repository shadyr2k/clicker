...
public class Stevia_Caelestis extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Stevia_Caelestis(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Stevia_Caelestis.png"));
