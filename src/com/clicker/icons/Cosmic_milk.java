...
public class Cosmic_milk extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Cosmic_milk(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Cosmic_milk.png"));
