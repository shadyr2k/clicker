...
public class Reinforced_membrane extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Reinforced_membrane(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Reinforced_membrane.png"));
