...
public class Four_leaf_cookie extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Four_leaf_cookie(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Four_leaf_cookie.png"));
