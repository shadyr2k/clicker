...
public class How_to_bake_your_dragon extends Icon {

    static int picX, picY;
    static Rectangle r;

    public How_to_bake_your_dragon(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/How_to_bake_your_dragon.png"));
