...
public class Sucralosia_Inutilis extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Sucralosia_Inutilis(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Sucralosia_Inutilis.png"));
