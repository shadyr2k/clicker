...
public class Lucky_Digit_Number_Payout extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Lucky_Digit_Number_Payout(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Lucky_Digit_Number_Payout.png"));
