...
public class Tin_of_butter_cookies extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Tin_of_butter_cookies(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Tin_of_butter_cookies.png"));
