...
public class Cosmic_beginners_luck extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Cosmic_beginners_luck(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Cosmic_beginners_luck.png"));
