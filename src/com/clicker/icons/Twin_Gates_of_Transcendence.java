...
public class Twin_Gates_of_Transcendence extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Twin_Gates_of_Transcendence(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Twin_Gates_of_Transcendence.png"));
