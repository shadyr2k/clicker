...
public class Shimmering_veil extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Shimmering_veil(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Shimmering_veil.png"));
