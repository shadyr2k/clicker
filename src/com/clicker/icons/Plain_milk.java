...
public class Plain_milk extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Plain_milk(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Plain_milk.png"));
