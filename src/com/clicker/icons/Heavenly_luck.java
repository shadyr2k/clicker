...
public class Heavenly_luck extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Heavenly_luck(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Heavenly_luck.png"));
