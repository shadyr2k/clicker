...
public class Seraphim extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Seraphim(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Seraphim.png"));
