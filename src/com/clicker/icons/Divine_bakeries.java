...
public class Divine_bakeries extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Divine_bakeries(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Divine_bakeries.png"));
