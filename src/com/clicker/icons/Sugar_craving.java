...
public class Sugar_craving extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Sugar_craving(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Sugar_craving.png"));
