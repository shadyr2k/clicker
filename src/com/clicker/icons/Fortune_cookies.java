...
public class Fortune_cookies extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Fortune_cookies(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Fortune_cookies.png"));
