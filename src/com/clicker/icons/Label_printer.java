...
public class Label_printer extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Label_printer(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Label_printer.png"));
