...
public class Unholy_bait extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Unholy_bait(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Unholy_bait.png"));
