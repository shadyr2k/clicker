...
public class Sugar_crystal_cookies extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Sugar_crystal_cookies(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Sugar_crystal_cookies.png"));
