...
public class Lucifer extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Lucifer(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Lucifer.png"));
