...
public class Starspawn extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Starspawn(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Starspawn.png"));
