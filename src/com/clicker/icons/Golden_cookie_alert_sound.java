...
public class Golden_cookie_alert_sound extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Golden_cookie_alert_sound(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Golden_cookie_alert_sound.png"));
