...
public class Box_of_brand_biscuits extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Box_of_brand_biscuits(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Box_of_brand_biscuits.png"));
