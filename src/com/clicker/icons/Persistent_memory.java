...
public class Persistent_memory extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Persistent_memory(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Persistent_memory.png"));
