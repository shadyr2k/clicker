...
public class Distilled_Essence_of_Redoubled_Luck extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Distilled_Essence_of_Redoubled_Luck(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Distilled_Essence_of_Redoubled_Luck.png"));
