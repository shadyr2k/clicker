...
public class Divine_discount extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Divine_discount(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Divine_discount.png"));
