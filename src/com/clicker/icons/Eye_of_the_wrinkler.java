...
public class Eye_of_the_wrinkler extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Eye_of_the_wrinkler(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Eye_of_the_wrinkler.png"));
