...
public class Sugar_baking extends Icon {

    static int picX, picY;
    static Rectangle r;

    public Sugar_baking(int x, int y, long price, ID id, String tag){
    ...
    public void render(Graphics g) {
        ...
        try {
            ...
            BufferedImage icon = ImageIO.read(new File("assets//sprites/Sugar_baking.png"));
