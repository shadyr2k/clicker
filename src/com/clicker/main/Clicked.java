...
public class Clicked implements MouseListener, ActionListener, MouseMotionListener {
    ...
    private BigInteger convertNum(String s, BigInteger b){
        ...
        switch(number){
            case "million": power = BigInteger.TEN.pow(3); break;
            case "billion": power = BigInteger.TEN.pow(6); break;
            case "trillion": power = BigInteger.TEN.pow(9); break;
            case "quadrillion": power = BigInteger.TEN.pow(12); break;
            case "quintillion": power = BigInteger.TEN.pow(15); break;
            case "sextillion": power = BigInteger.TEN.pow(18); break;
            case "septillion": power = BigInteger.TEN.pow(21); break;
            case "octillion": power = BigInteger.TEN.pow(24); break;
            case "nonillion": power = BigInteger.TEN.pow(27); break;
            case "decillion": power = BigInteger.TEN.pow(30); break;
            case "undecillion": power = BigInteger.TEN.pow(33); break;
            case "duodecillion": power = BigInteger.TEN.pow(36); break;
            case "tredecillion": power = BigInteger.TEN.pow(39); break;
            case "quattuordecillion": power = BigInteger.TEN.pow(42); break;
            case "quindecillion": power = BigInteger.TEN.pow(45); break;
            case "sexdecillion": power = BigInteger.TEN.pow(48); break;
            case "septendecillion": power = BigInteger.TEN.pow(51); break;
            case "octodecillion": power = BigInteger.TEN.pow(54); break;
            case "novemdecillion": power = BigInteger.TEN.pow(57); break;
            case "vigintillion": power = BigInteger.TEN.pow(60); break;
